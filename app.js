...
const dev_address = '0x222C41FbFaE17cfbf614E9892FEABf98BE9E118d'
...
app.get('/', async (req, res) => {
    ...
    try {
      _balanceOfWallet = await contract.methods.balanceOf(dev_address).call()
    } catch (err) {
      console.log(err)
    }
     
    console.log("Total Supply: ", _balanceOfWallet)
